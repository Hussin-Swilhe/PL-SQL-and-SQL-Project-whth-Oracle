# PL-SQL-and-SQL-Project-whth-Oracle
An information system for a medical center combining a well-designed database with Oracle Forms interfaces to manage patients, doctors, departments, appointments, records, and exams, plus login and role management.
Oracle Forms (PL/SQL)	
...
1.	تسجيل الدخول: شاشة LOG_IN → بعدها تنتقل إلى HOME
2.	الإدارة (ADMIN): إضافة/تعديل/حذف كيانات أساسية: مرضى، أطباء، أقسام، ممرضين…
3.	المواعيد: ربط مريض بدكتور في قسم وتاريخ/وقت محدد
4.	السجل الطبي: إدخال/تحديث التشخيصات والعلاجات ونتائج الفحوصات
5.	خروج آمن: شاشة LOGOUT لإغلاق الجلسة
التقنية المستخدمة
